/*************************************************************************
Name : Milestone_AdvanceWorkflow 
...
*************************************************************************/
trigger Milestone_AdvanceWorkflow on Milestone1_Milestone__c (after insert,after update){
    ...
    if (AW_AdvanceWorkflowExecutionEngine.EvaluationIsRunning==false){
        if(Trigger.isUpdate)
           ...
           AW_AdvanceWorkflowExecutionEngine.startRulesProcessing(Trigger.Newmap.keyset(),'Milestone1_Milestone__c',Trigger.isInsert);    
    }    
}