/*************************************************************************
Name : BillEvtItem_AdvanceWorkflow 
...
*************************************************************************/
trigger BillEvtItem_AdvanceWorkflow on pse__Billing_Event_Item__c (after insert,after update){
    ...
    if (AW_AdvanceWorkflowExecutionEngine.EvaluationIsRunning==false){
        if(Trigger.isUpdate)
           ...
           AW_AdvanceWorkflowExecutionEngine.startRulesProcessing(Trigger.Newmap.keyset(),'pse__Billing_Event_Item__c',Trigger.isInsert);    
    }    
}