...
*************************************************************************/
trigger Project_AdvanceWorkflow on pse__Proj__c (after insert,after update){
    ...
    if (AW_AdvanceWorkflowExecutionEngine.EvaluationIsRunning==false){
        if(Trigger.isUpdate)
           ...
           AW_AdvanceWorkflowExecutionEngine.startRulesProcessing(Trigger.Newmap.keyset(),'pse__Proj__c',Trigger.isInsert);    
    }    
}