/*************************************************************************
Name : ExpenseRep_AdvanceWorkflow 
...
*************************************************************************/
trigger ExpenseRep_AdvanceWorkflow on pse__Expense_Report__c (after insert,after update){
    ...
    if (AW_AdvanceWorkflowExecutionEngine.EvaluationIsRunning==false){
        if(Trigger.isUpdate)
           ...
           AW_AdvanceWorkflowExecutionEngine.startRulesProcessing(Trigger.Newmap.keyset(),'pse__Expense_Report__c',Trigger.isInsert);    
    }    
}